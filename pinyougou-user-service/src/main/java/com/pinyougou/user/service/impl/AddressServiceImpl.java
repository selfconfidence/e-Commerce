...
public class AddressServiceImpl implements AddressService {
	...
	public PageResult findPage(TbAddress address, int pageNum, int pageSize) {
		...
		@Override
		public List<TbAddress> findListUserIdAddress(String userName) {
			TbAddressExample example = new TbAddressExample();
			Criteria criteria = example.createCriteria();
         ...
         //用户中心设置默认逻辑
		@Override
		public void isAddressDefault(Long addressId) {
         List<TbAddress> byExample = addressMapper.selectByExample(null);	
         for (TbAddress tbAddress : byExample) {
			if(tbAddress.getId()==addressId){
